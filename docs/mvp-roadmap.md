...
| 7 | `android-catalog-substitutions` | Exercise catalog approval, substitution flow, prescribed/performed history | Workout logging, stats |
| 8 | `android-rest-timers` | Timer policy, permissions, foreground-service locked alerts | Workout runtime UX |
| 9 | `android-stats-history` | History, PRs, e1RM, substitution stats, source drilldowns | Android acceptance, optional Web fixture data definitions |
| 10 | `web-readonly` | Online-only read-only Web surfaces over explicit snapshots | Web inspection/review surfaces |
| 11 | `acceptance-hardening` | Edge cases, privacy checks, final verification, coverage critique | MVP release decision |
