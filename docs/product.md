...
| A6 Spreadsheet import output | Program Construct Matrix, validation severity, import privacy, JSON resource versioning | UT-IMP-001 construct classification; UT-IMP-002 severity assignment; UT-IMP-003 provenance privacy; UT-JSON-001 schema version required | IT-IMP-001 spreadsheet to JSON/report; IT-IMP-002 activation blocked by critical; IT-IMP-003 approved exercise mappings required | CLI-IMP-001 private fixture import |
| A7 Import correction/finalization | Validation severity, JSON versioning, import privacy, skill workflow | UT-IMP-004 correction clears critical; UT-JSON-002 resource version identity; UT-IMP-005 consent gate required | IT-IMP-004 correction reruns validation; IT-IMP-005 finalization preserves audit; IT-IMP-006 same version different hash rejected | CLI-IMP-002 Copilot correction loop |
