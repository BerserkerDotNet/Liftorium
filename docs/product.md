...
- 1RM/reference values where required by a program.
- Percent/1RM prescriptions.
...
- A8: User updates a 1RM and future calculated prescriptions change while historical workouts remain unchanged.
